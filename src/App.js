...
import defaultReducer, { initialState } from './assets/store/reducers/reducer';
          ...
          value={
            {
              ...
              allDepartmentsData: state.allDepartments,
              allUsersData: state.allUsers, 
              allVacationsData: state.allVacations,
              allYearsData: state.allYears,
              dispatch,
              updateYears
            }
          }
